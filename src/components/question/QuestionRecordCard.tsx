      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 flex-1 space-y-3">
            ...
            <section className="space-y-2 rounded-xl bg-slate-50/80 p-3">
              <p className="text-xs font-bold uppercase tracking-wide text-slate-500">학생 질문</p>
            ...
            <section className="space-y-2 rounded-xl border border-blue-100 bg-blue-50/40 p-3">
              <p className="text-xs font-bold uppercase tracking-wide text-blue-800">강사 답변</p>
              {answered ? (
                <>
                  {record.answer?.trim() && (
