      ...
      {isEnglish ? (
        <div>
          ...
          <div className="mt-1.5 grid grid-cols-2 gap-2">
            <div className="rounded-xl border border-[rgba(22,58,112,0.1)] bg-[rgba(22,58,112,0.04)] px-3 py-2.5 text-center">
              <p className="text-[11px] font-semibold text-slate-600">점수</p>
              <p className="mt-0.5 text-base font-bold tabular-nums text-[#163A70]">
                {diagnosis.englishListeningScore !== null
                  ? `${diagnosis.englishListeningScore}점`
                  : '-'}
              </p>
            </div>
            <div
              className={`flex flex-col items-center justify-center rounded-xl border px-3 py-2.5 text-center ${
                diagnosis.englishListeningResult
                  ? getDailyTestSessionColor(diagnosis.englishListeningResult)
                  : 'border-[rgba(22,58,112,0.1)] bg-white text-slate-500'
              }`}
            >
              <p className="text-[11px] font-semibold opacity-80">결과</p>
              <p className="mt-0.5 text-sm font-bold">
                {diagnosis.englishListeningResult ?? '미입력'}
              </p>
            </div>
          </div>
        </div>
