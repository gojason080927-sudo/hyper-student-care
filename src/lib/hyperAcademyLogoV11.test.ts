...
const iconGenerator = readFileSync('scripts/generate-pwa-icons-v11.mjs', 'utf8')
...
assert.match(iconGenerator, /MASKABLE_FIT = 0\.80/)
assert.doesNotMatch(iconGenerator, /MASKABLE_FIT = 0\.64/)
