...
assert.match(teacherManifest, /hyper-teacher-icon-v21-512\.png/)
assert.doesNotMatch(teacherManifest, /hyper-teacher-icon-v20-512/)
assert.match(parentManifest, /hyper-parent-icon-v21-512\.png/)
assert.doesNotMatch(parentManifest, /hyper-parent-icon-v20-512/)
assert.match(hubManifest, /hyper-hub-icon-v21-512\.png/)
assert.doesNotMatch(hubManifest, /hyper-hub-icon-v20-512/)
assert.match(indexHtml, /v=21-installable/)
assert.doesNotMatch(indexHtml, /v=20-installable/)
