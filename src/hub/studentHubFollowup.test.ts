...
assert.match(teacherRepo, /hubInboxReplyUpdatePayload/)
assert.match(teacherRepo, /requireHubInboxUpdatedRow/)
assert.match(teacherCms, /label: '건의'/)
assert.match(teacherCms, /HUB_INBOX_REPLY_SAVE_SUCCESS/)
assert.match(teacherCms, /onItemPatched/)
