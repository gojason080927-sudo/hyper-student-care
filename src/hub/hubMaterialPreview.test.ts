...
assert.equal(
  hubServiceWorkerShouldIntercept('/storage/v1/object/sign/hub-learning-materials/x', 'navigate', false),
  false,
)
...
assert.doesNotMatch(hubMaterials, /hubPreviewPagesToViewerPages/)
...
assert.doesNotMatch(hubMaterials, /diagCode/)
assert.doesNotMatch(hubMaterials, /IMAGE-ERROR/)
