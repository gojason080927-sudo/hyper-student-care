...
assert.match(teacherDashboard, /학생 앱의 오늘의 과제·문제 자료·영상 자료/)
...
assert.match(teacherCms, /useState<Tab>\('assignments'\)/)
assert.match(teacherCms, /label: '오늘의 과제'/)
assert.match(teacherCms, /반 과제 게시/)
...
assert.doesNotMatch(teacherCms, /반 공통 오늘 과제/)
