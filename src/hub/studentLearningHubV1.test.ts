...
assert.match(teacherRepo, /teacherDeleteMaterial/)
assert.match(teacherRepo, /teacherDeleteVideo/)
...
assert.match(hubMiddleware, /\/hub\/manifest.webmanifest\?v=21-installable/)
