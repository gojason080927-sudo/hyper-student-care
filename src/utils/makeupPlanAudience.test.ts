...
assert.doesNotMatch(dataHook.slice(dataHook.indexOf('const saveMakeupPlanRecord')), /notifyHubPush/)
assert.doesNotMatch(dataHook.slice(dataHook.indexOf('const saveMakeupPlanRecords')), /notifyHubPush/)
